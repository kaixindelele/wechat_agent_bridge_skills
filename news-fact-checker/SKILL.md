...
简要说明验证过程和发现，梳理原帖的每个关键点的报道依据，列出所有找到的靠谱上下文和链接。
...
- 只要已经定位到原帖、原始报道、官方账号帖子、官方博客、原始公告中的任意一种，`原帖 / 原始来源` 小节里**必须给出可点击 URL**
- 不允许只在正文里写“已找到原帖”或“原帖可回溯”，但不给链接
- 如果没找到原帖，也要明确写 `未找到可信原帖`，并说明搜索范围或限制
- 如果 X/推特原链访问受限，但能找到可信镜像、归档、聚合索引页，也要一并列出，优先级写成：原链 > 官方镜像/归档 > 可信索引页
...
- 如果结论是 **确认为真** 或 **大概率为真**，且你已经找到了原帖 / 原始来源，`参考链接` 第一条**必须**是 `原帖` 或 `原始来源`
- 不要把原帖链接省略成“原文”或埋在前文段落里，链接清单里必须单独列出
- 不要只输出“总结要点”或“结论摘要”；最终回复必须保留完整链接区块，方便用户二次传播和复核
- 如果原帖不存在，但有原始报道或官方公告，也要在链接清单里明确写成 `原始来源`
...
参考链接：
- 原帖/原始来源：Meta 官方说明或原始报道标题+URL
- 原文：Reuters 标题+https://www.reuters.com/xxx
...
- 是否明确给出了真伪判断
- 如果找到了原帖 / 原始来源，是否在最终回复里单独列出了链接
- 是否给出了至少 2 条权威媒体或官方来源，或说明为什么没有
- 是否保留了一个方便用户直接复制转发的短综述
- 是否避免把“真实存在的原帖”漏掉，只剩媒体报道链接
